...
*********************************************************
* SPICE 3f5 Level 8, HSPICE Level 49, LTSpice Level 8   *
*********************************************************
...
* ideal BALUN - by Boris Murmann
* example instantiation
* x1 vdm vcm vp vm bal 
.subckt bal vdm vcm vp vm
e1 vp vcm transformer vdm 0 2
e2 vcm vm transformer vdm 0 2
.ends bal

*
* BALUN circuit - by Ken Kundert
*
...
e2 nodeB vm vdm 0 0.5 
v2 vcm nodeC
f2 vdm 0 v2 -0.5
R2 nodeC nodeB 10u ; do not make the value too small!
.ends
