...
t = readtable('./simulations/techsweep_n.txt');
a = table2array(t);

% column vectors from ngspice
% 1 v-sweep
% 2 @n.xm1.nsg13_lv_nmos[cdd]
% 3 @n.xm1.nsg13_lv_nmos[cgb]
% 4 @n.xm1.nsg13_lv_nmos[cgd]
% 5 @n.xm1.nsg13_lv_nmos[cgdol]
% 6 @n.xm1.nsg13_lv_nmos[cgg]
% 7 @n.xm1.nsg13_lv_nmos[cgs]
% 8 @n.xm1.nsg13_lv_nmos[cgsol]
% 9 @n.xm1.nsg13_lv_nmos[cjd]
% 10 @n.xm1.nsg13_lv_nmos[cjs]
% 11 @n.xm1.nsg13_lv_nmos[css]
% 12 @n.xm1.nsg13_lv_nmos[gds]
% 13 @n.xm1.nsg13_lv_nmos[gm]
% 14 @n.xm1.nsg13_lv_nmos[gmb]
% 15 @n.xm1.nsg13_lv_nmos[ids]
% 16 @n.xm1.nsg13_lv_nmos[vth]
% 17 v-sweep
