...
plot vm(out)
write igs_ex3_4a_ac_fix.raw v(out)
...
C {devices/isource.sym} -700 -440 0 0 {name=IBIAS1 value=180e-6}
...
C {devices/lab_wire.sym} -620 -380 0 0 {name=p3 sig_type=std_logic lab=ref}
