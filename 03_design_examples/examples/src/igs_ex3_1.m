...
gmID1
% intrinsic gain at the computed values of gm/ID at L= [0.13.0.18 0.23 0.28] um   
Avo1
Avo2

% plot (gm/ID, Avo) pairs for L = [0.13 0.18 0.23 0.28] um
figure(1)
...
% I don't understand what the following line is supposed to do !!
% Y1plot = 15/6*Avo1 
% This line is in the original script, but not really used anywhere else 
% gm/ID = 15 ?
% 6 = L      ?
