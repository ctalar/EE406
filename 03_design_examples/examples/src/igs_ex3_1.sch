...
C {devices/vsource.sym} -410 -230 0 0 {name=Vgsn value="DC 0.4792 AC 1" savecurrent=false}
...
C {devices/isource.sym} -290 -440 0 0 {name=IBIAS value=418.88e-6}
