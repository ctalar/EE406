...
C {devices/vsource.sym} -410 -230 0 0 {name=Vgsn value="DC 0.3233 AC 1" savecurrent=false}
...
C {devices/isource.sym} -290 -440 0 0 {name=IBIAS value=41.88e-6}
